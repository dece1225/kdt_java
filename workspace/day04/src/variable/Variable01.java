...
// 1번 : 변수선언
public class Variable01 { // class 중괄호 시작영역

	public static void main(String[] args) { // main 메소드 중괄호 시작영역
		// 변수선언
		// 자료형 변수명;
		int number1; // 정수형 타입의 값을 저장 할 수 있는 number1 변수를 만들었다.
		boolean isTrue; // 논리형 타입의 값을 저장 할 수 있는 isTrue 변수를 만들었다.
		double number2; // 실수형 타입의 값을 저장 할 수 있는 number2 변수를 만들었다.
		...
		// 번수 선언과 동시에 초기화(처음으로 값을 저장하는 것)
		// 자료형 변수명 = 값;
		int number3 = 100; // 정수를 저장할 수 있는 변수 number3를 선언하고 100이라는 정수형 값으로 초기화 했다(저장 했다)
		// int number3;
		// number3 = 100;
		System.out.println(number3); // number3라는 변수에 저장된 100이라는 정수형 값을 콘솔창에 출력한다
